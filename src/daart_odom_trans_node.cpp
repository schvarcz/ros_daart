...
public:
    ...
    OdomTrans () : topic2clean("/odom_encoder"), topicPub("/odom"), childFrame("base_link"), frameId("odom")
    {
        ...
        sub1 = n.subscribe(ns+topic2clean, 100, &OdomTrans::odomCallback, this);
...
int main(int argc, char** argv){
  ros::init(argc, argv, "daart_odom_trans");
